...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  ...
  Class.prototype.pullData = function(curr){
    ...
    if(options.url){ //Ajax请求
      //add woate 20191210
	  var where = $.extend({}, options.where);
	  var data = requestData(curr, options.limit, where);
      //modify woate 20191210 var params = {};
      //modify woate 20191210 params[request.pageName] = curr;
      //modify woate 20191210 params[request.limitName] = options.limit;
	  //modify woate 20191210 if(options.contentType && options.contentType.indexOf("application/json") == 0){ //提交 json 格式
	  //modify woate 20191210   data = JSON.stringify(data);
	  //modify woate 20191210 }
      //modify woate 20191210 参数
      //modify woate 20191210 var data = $.extend(params, options.where);
